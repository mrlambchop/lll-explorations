...
const particleExample :Workerd.Config = (
  ...
  services = [  (name = "main", worker = .particle),
                #(name = "particleAPI", external = .particleAPI),
                ( name = "internet",
                  network = (
...
# The definition of the actual particle worker exposed using the "main" service.
...
const particle :Workerd.Worker = (
  modules = [
    (name = "myTestApplication", esModule = embed "myTestApplication.js"),
    (name = "particleAPI", esModule = embed "particleAPI.js")
  ],
  compatibilityDate = "2023-02-28",
);

const particleAPI :Workerd.ExternalServer = (
